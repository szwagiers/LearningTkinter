...
Button_2 = Button(root,text='2',padx=31,pady=15,command=lambda:button_click(2))
...
Button_5 = Button(root,text='5',padx=31,pady=15,command=lambda:button_click(5))
...
Button_8 = Button(root,text='8',padx=31,pady=15,command=lambda:button_click(8))
...
Button_Div = Button(root,text='/',padx=29,pady=15,command=button_div)
Button_Mul = Button(root,text='*',padx=29,pady=15,command=button_mul)

Button_Eq = Button(root,text='=',padx=69,pady=15,command=button_equal)
Button_Cl = Button(root,text='C',padx=69,pady=15,command=button_clear)
...
Button_Cl.grid(row=5,column=1,columnspan=2)
